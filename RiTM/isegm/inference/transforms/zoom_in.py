...
from RiTM.isegm.inference.clicker import Click
from RiTM.isegm.utils.misc import get_bbox_iou, get_bbox_from_mask, expand_bbox, clamp_bbox
...
class ZoomIn(BaseTransform):
    ...
    def transform(self, image_nd, clicks_lists: List[List[Click]]):
        ...
        if len(clicks_list) <= self.skip_clicks:    # Pas de transformation zoom_in pour le premier click
