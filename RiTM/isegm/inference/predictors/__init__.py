...
from RiTM.isegm.inference.transforms import ZoomIn
from RiTM.isegm.model.is_hrnet_model import HRNetModel
...
def get_predictor(net, brs_mode, device,
                  ...
                  lbfgs_params=None):
    # print('zoom_in_params for get_predictor:',zoom_in_params)
    lbfgs_params_ = {
        'm': 20,
        'factr': 0,
        'pgtol': 1e-8,
    ...
    # print('zoom_in for get_predictor:',zoom_in)
