...
from RiTM.isegm.data.datasets import GrabCutDataset, BerkeleyDataset, DavisDataset, SBDEvaluationDataset, PascalVocDataset
from RiTM.isegm.utils.serialization import load_model
...
def load_single_is_model(state_dict, device, **kwargs):
    state_dict['config']['class']= 'RiTM.' + state_dict['config']['class']
...
def find_checkpoint(weights_folder, checkpoint_name):
    ...
    if checkpoint_name.endswith('.pth'):
        ...
        print(list(model_folder.rglob(f'{checkpoint_name}*.pth')))
