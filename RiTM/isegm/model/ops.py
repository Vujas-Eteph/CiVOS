...
import numpy as np
import RiTM.isegm.model.initializer as initializer
...
class DistMaps(nn.Module):
    def __init__(self, norm_radius, spatial_scale=1.0, cpu_mode=False, use_disks=False):
        ...
        # self.cpu_mode = False # El psy kongroo
        if self.cpu_mode:
            from RiTM.isegm.utils.cython import get_dist_maps
            self._get_dist_maps = get_dist_maps     # This may be the cause of error... ??
